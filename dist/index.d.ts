...
declare const SEPAReversalReasonCode: {
    readonly Duplication: "DUPL";
    readonly TechnicalProblem: "TECH";
    readonly FraudulentOriginal: "FRAD";
    readonly CutOffTime: "CUTA";
    readonly AmountDiffers: "AM05";
    readonly InvalidDebtorAccount: "AC04";
    readonly NotSpecifiedCustomerGenerated: "MS02";
    readonly NotSpecifiedAgentGenerated: "MS03";
};
...
interface OriginalMessageReference {
    msgId: string;
    msgNmId: string;
...
interface SEPADirectDebitReversalTransaction {
    reversalId?: string;
...
interface SEPADirectDebitReversalInstructionGroup {
    paymentInformationId?: string;
    creditor: Party;
    creditorSchemeId: string;
    sequenceType: SEPASequenceType;
    localInstrument?: SEPALocalInstrument;
    reversals: AtLeastOne$6<SEPADirectDebitReversalTransaction>;
}
interface SEPADirectDebitPaymentReversalConfig {
    initiatingParty: Party;
    messageId?: string;
    creationDate?: Date;
    originalMessage: OriginalMessageReference;
    reversalInstructions: AtLeastOne$6<SEPADirectDebitReversalInstructionGroup>;
}
declare class SEPADirectDebitPaymentReversal extends PaymentInitiation {
    initiatingParty: Party;
    messageId: string;
    creationDate: Date;
    originalMessage: OriginalMessageReference;
    ...
    static fromOriginalInitiation(original: SEPADirectDebitPaymentInitiation, reversals: Array<{
        endToEndId: string;
        reversedAmount?: number;
        reason: SEPAReversalReason;
        reversalId?: string;
...
export type { ABAAgent, ACHCreditPaymentInitiationConfig$1 as ACHCreditPaymentInitiationConfig, ACHCreditPaymentInstruction, ACHLocalInstrument, Account, Agent, AtLeastOne$6 as AtLeastOne, BICAgent, Balance, BalanceType, BaseAccount, BaseStatusInformation as BaseStatus, Entry, GroupStatusInformation as GroupStatus, IBANAccount, MandateAmendmentInformation, MandateInformation, OriginalGroupInformation, OriginalMessageReference, OriginalTransactionReference, Party, PaymentStatusInformation as PaymentStatus, RTPCreditPaymentInitiationConfig$1 as RTPCreditPaymentInitiationConfig, RTPCreditPaymentInstruction, SEPACreditPaymentInitiationConfig$1 as SEPACreditPaymentInitiationConfig, SEPACreditPaymentInstruction, SEPADirectDebitPaymentInitiationConfig$1 as SEPADirectDebitPaymentInitiationConfig, SEPADirectDebitPaymentInstruction, SEPADirectDebitPaymentInstructionGroup, SEPADirectDebitPaymentReversalConfig, SEPADirectDebitReversalInstructionGroup, SEPADirectDebitReversalTransaction, SEPALocalInstrument, SEPAMultiCreditPaymentInitiationConfig$1 as SEPAMultiCreditPaymentInitiationConfig, SEPAMultiCreditPaymentInstructionGroup, SEPAReversalReason, SEPASequenceType, SWIFTCreditPaymentInitiationConfig$1 as SWIFTCreditPaymentInitiationConfig, SWIFTCreditPaymentInstruction, Statement, PaymentStatus as Status, StatusInformation, StatusType, StructuredAddress, Transaction, TransactionStatusInformation as TransactionStatus };
