...
export declare const parseAccountIdentification: (
  accountId: any,
) => AccountIdentification;
export declare const exportAccountIdentification: (
  accountId: AccountIdentification,
) => any;
export declare const parseAgent: (agent: any) => Agent;
export declare const parseMandate: (mandateInfo: any) => MandateInformation;
export declare const exportAgent: (agent: Agent) => any;
export declare const parseAmountToMinorUnits: (
  rawAmount: number | string,
  currency?: Currency,
) => number;
export declare const exportAmountToString: (
  amount: number,
  currency?: Currency,
) => string;
...
export declare const exportRecipient: (
  recipient: ReturnType<typeof parseRecipient>,
) => any;
export declare const parseAdditionalInformation: (
