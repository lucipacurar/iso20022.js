import type { ABAAgent, BaseAccount } from '../../../src/index';
import ISO20022 from '../../../src/iso20022';
import type { Alpha2Country } from '../../../src/lib/countries';
import {
  RTPCreditPaymentInitiation,
  type RTPCreditPaymentInitiationConfig,
} from '../../../src/pain/001/rtp-credit-payment-initiation';
...
describe('RTPCreditPaymentInitiation', () => {
  ...
  describe('serialize', () => {
    ...
    test('should serialize to XML', () => {
      ...
      expect(xml).toMatch(
        /<LclInstrm>\s*<Prtry>\s*RTP\s*<\/Prtry>\s*<\/LclInstrm>/,
      );
    });
    ...
    describe('created with iso20022', () => {
      ...
      test('should create a RTPCreditPaymentInitiation instance', () => {
        const rtpPayment = iso20022.createRTPCreditPaymentInitiation({
  ...
  describe('fromXML', () => {
    describe('with Cross River 001 XML file', () => {
      ...
      test('should correctly parse message metadata', () => {
        ...
        expect(rtpPayment.creationDate).toStrictEqual(
      ...
      test('should correctly parse initiating party information', () => {
        ...
        expect(
          (rtpPayment.initiatingParty.account as BaseAccount).accountNumber,
        ).toBe('1123456789');

        // Check agent (bank) information
        expect(rtpPayment.initiatingParty.agent).toBeDefined();
        expect(
          (rtpPayment.initiatingParty.agent as ABAAgent).abaRoutingNumber,
        ).toBe('123456789');
      });
    ...
    describe('with generated RTP 001 XML file', () => {
      ...
      const recreatedRtpPayment =
        RTPCreditPaymentInitiation.fromXML(serializedXml);
      ...
      test('information should be correctly parsed', () => {
        ...
        expect(recreatedRtpPayment.initiatingParty.name).toBe(
